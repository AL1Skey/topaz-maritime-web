...
const submitForm = async() => {
  ...
  formDataObj.append('maritalStatusName', maritalStatusOptions[formData.maritalStatusId]);
  ...
  formDataObj.append('nationalityName', nationalityOptions[formData.nationalityId]);
